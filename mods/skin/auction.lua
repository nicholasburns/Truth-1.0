...
--[[ BROWSING TAB
	------------
	local AuctionFrame				     	= AuctionFrame								-- AuctionFrame
	...
	local AuctionProgressBar                	= AuctionProgressBar						-- AuctionProgress
...
--[[
	--
	local AuctionsCancelAuctionButton       	= AuctionsCancelAuctionButton					-- Auctions
...
--[[	BID
	local BidBuyoutButton                   	= BidBuyoutButton							-- Big
	...
	local BidBidButton                      	= BidBidButton								-- BidBig
...
--[[ UNKNOWN
	local BuyoutPriceCopper                      = BuyoutPriceCopper							-- Buyout
	local BuyoutPriceSilver                      = BuyoutPriceSilver
	local BuyoutPriceGold                        = BuyoutPriceGold

	local StartPriceCopper                       = StartPriceCopper							-- StartPrice
...
--[[
	...
	--	Objects
	--=========================================--
	local BrowseDropDown                    	= BrowseDropDown				-- Dropdowns
	local PriceDropDown                     	= PriceDropDown
	local DurationDropDown                  	= DurationDropDown
	local IsUsableCheckButton               	= IsUsableCheckButton			-- Check Buttons
	local ShowOnPlayerCheckButton           	= ShowOnPlayerCheckButton
	local BrowseBuyoutButton                	= BrowseBuyoutButton			-- Buttons
	...
	local BrowseNextPageButton              	= BrowseNextPageButton			-- PrevNexts
