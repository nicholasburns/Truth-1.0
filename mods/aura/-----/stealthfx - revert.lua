...
--~  [Note] .1 = 10-th of the sound bar (0 = mute / 1 = max volume)
	...
	if ((T.PlayerIsRogue() or T.PlayerIsDruid()) and Volume ~= 0) then
		...
		if (BuffExists("Stealth") or BuffExists("Vanish")) then
			...
			-- PlayMusic(Addon.media.sound.affliction)	--~  Dong! .... Dong! .... Dong! ....	--> Deep Percussion Drum (slow / steady tempo)
			PlayMusic(Addon.media.sound.failure)		--~  Thud!.. Thud!.. Thud!			--> Snare Drumm-ish (medium / steady tempo)
